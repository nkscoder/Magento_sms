...
namespace Scaledesk\Trails\Model;

use \Magento\Framework\Model\AbstractModel;
use \Magento\Framework\DataObject\IdentityInterface;
use \Scaledesk\Trails\Api\Data\PostInterface;

/**
 * Class File
 * @package Scaledesk\Post\Model
...
class Post extends AbstractModel implements PostInterface, IdentityInterface
{
     ...
     * Cache tag
     */
    const CACHE_TAG = 'scaledesk_trails';
    ...
    {
        $this->_init('Scaledesk\Trails\Model\ResourceModel\Post');
    }
